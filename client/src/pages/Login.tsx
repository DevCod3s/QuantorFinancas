      ...
      <div className="flex items-center relative">
        ...
        <div className="w-32 h-[480px] bg-gray-50 rounded-l-3xl shadow-lg flex flex-col items-center py-8 relative">
          ...
          <div className="flex flex-col items-center mb-10">
            ...
            <span className="text-gray-700 text-xs tracking-wide pt-[7px] pb-[7px] mt-[8px] mb-[8px] font-extrabold">
              QUANTOR
            </span>
          </div>
          ...
          <div className="flex flex-col space-y-8 relative">
            ...
            <button
              ...
              className="p-3 rounded-lg transition-colors text-blue-600 pt-[12px] pb-[12px] pl-[10px] pr-[10px] mt-[22px] mb-[22px]"
            >
